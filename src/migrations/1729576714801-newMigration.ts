...
export class NewMigration1729576714801 implements MigrationInterface {
    name = 'NewMigration1729576714801'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`type_sprinding\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`estimatedAmount\` decimal(10,2) NOT NULL, \`abbreviation\` varchar(255) NOT NULL, \`userId\` int NULL, \`colorId\` int NULL, \`iconId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
