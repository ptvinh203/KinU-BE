...
values  (1, 'Chi tiêu khác', 0.00, '', 2, 1, 1),
        ...
        (8, 'Internet', 100000.00, 'DT', 2, 6, 11),
        (9, 'Thú nuôi', 500000.00, 'TNN', 2, 24, 8),
        (10, 'Giải trí', 300000.00, 'GT', 2, 3, 25),
        (11, 'Chụp ảnh', 40000.00, 'CA', 2, 6, 9),
        (12, 'Ăn uống', 2000000.00, 'AU', 3, 8, 21),
        (13, 'Quần áo', 500000.00, 'QA', 3, 24, 8),
        (14, 'Mỹ phẩm', 500000.00, 'MP', 3, 7, 4),
        (15, 'Y tế', 500000.00, 'YT', 3, 12, 20),
        (16, 'Giáo dục', 500000.00, 'GD', 3, 10, 14),
        (17, 'Internet', 100000.00, 'DT', 3, 6, 11),
        (18, 'Thú nuôi', 500000.00, 'TNN', 3, 24, 8),
        (19, 'Giải trí', 300000.00, 'GT', 3, 3, 25),
        (20, 'Chụp ảnh', 40000.00, 'CA', 3, 6, 9);
